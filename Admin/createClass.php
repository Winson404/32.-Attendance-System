<?php include 'navbar.php'; ?>
    ...
    <div class="container-fluid" id="container-wrapper">
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Program records</h1>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="">Home</a></li>
          <li class="breadcrumb-item active" aria-current="page">Program records</li>
        </ol>
      </div>
            ...
            <div class="card-header">
              ...
              <table class="table table-flush table-hover" id="dataTableHover">
                ...
                <tbody>
                  <?php 
                    $i = 1;
                    $fetch = mysqli_query($conn, "SELECT * FROM tblclass");
                  ...
                  <?php include 'createClass_update_delete.php'; } ?>
                </tbody>
              </table>
          </div>
        </div>
...
<?php include 'createClass_add.php'; ?>   
