<?php include 'navbar.php'; ?>
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <!-- New User Card Example -->
            <?php 
            $query1= mysqli_query($conn, "SELECT Id FROM tblstudents WHERE classId = '$log_classId' and classArmId = '$log_classArmId' ");                       
            ...
            <?php 
              $query1=mysqli_query($conn,"SELECT Id FROM tblclassteacher WHERE classId='$log_classId' AND teacherId='$Id' ");                       
            ...
            <!-- Earnings (Annual) Card Example -->
             <?php 
                $query1=mysqli_query($conn,"SELECT Id FROM tblclassteacher WHERE classArmId='$log_classArmId' AND teacherId='$Id' ");                    
            ...
            <?php 
              $query1=mysqli_query($conn,"SELECT Id FROM tblattendance WHERE teacherId='$Id' AND classId='$log_classId' AND classArmId='$log_classArmId'");
